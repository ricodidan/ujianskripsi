          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input id="tanggal_lahir" type="text" class="form-control flatpickr-basic @error('tanggal_lahir') is-invalid @enderror" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" required autocomplete="tanggal_lahir">
            ...
            <div class="col-12 d-flex flex-sm-row flex-column mt-2">
              <input type="submit" class="btn btn-primary mb-1 mb-sm-0 mr-0 mr-sm-1" value="Tambah Balita">
